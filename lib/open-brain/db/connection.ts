...
const DB_PATH = process.env.OPEN_BRAIN_DB_PATH || path.join(process.cwd(), 'data', 'open-brain.db')
...
function initializeSchema(database: Database.Database): void {
  ...
  // If schema.sql file exists, read from it; otherwise use inline schema
  let schema: string
