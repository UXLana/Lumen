 ...
 * Generated by Lumen Theme Playground on 2026-04-02
 * Brand color: #385C3F
 */
...
export const springTheme: ProductTheme = {
  name: 'spring',
  colors: {
    brand: {
      default: '#385C3F',
    ...
    text: {
      ...
      disabled: {
        // WCAG remediation: was 0.30 → 2.10:1. Bumped for informational use.
    ...
    border: {
      ...
      lowEmphasis: {
        onLight: 'rgba(0, 0, 0, 0.10)', // decorative — subtle hairline
      ...
      midEmphasis: {
        onLight: '#727A75', // interactive — passes 3:1 for inputs/buttons
    ...
    status: {
      // WCAG remediation: success/important failed on lightDarker cards, warning on light.
      info: '#4A6E50',
      info_onDark: 'rgba(56, 92, 63, 0.25)',
      success: '#0F6854', // was #1B7F66 → 4.31:1 on lightDarker
      success_onDark: 'rgba(0, 173, 130, 0.25)',
      warning: '#8F5000', // was #CC7300 → 3.30:1
      warningLight: '#F3DCBD',
      warning_onDark: 'rgba(230, 130, 0, 0.25)',
    ...
    navBackground: 'rgba(247, 249, 247, 0.85)',
    navBlur: '12px',
    headerBackground: 'rgba(247, 249, 247, 0.85)',
    headerBlur: '12px',
