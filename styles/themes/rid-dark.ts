 ...
 * Brand accent: #5AAC90 (bright teal) for buttons, active states, links.
...
export const ridDarkTheme: ProductTheme = {
  ...
  // ===========================================================================
  // TYPOGRAPHY — Enterprise: Segoe UI for system-native feel
  // ===========================================================================
  typography: {
    fontFamilies: {
      display: '"Segoe UI", var(--font-inter), -apple-system, BlinkMacSystemFont, sans-serif',
      body: '"Segoe UI", var(--font-inter), -apple-system, BlinkMacSystemFont, sans-serif',
