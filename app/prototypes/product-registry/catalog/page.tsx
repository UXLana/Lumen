...
function CategoryIcon({ category }: { category: string }) {
  const iconMap: Record<string, { emoji: string; bg: string }> = {
    flower: { emoji: '🌿', bg: colors.surface.success },
    concentrate: { emoji: '💧', bg: colors.surface.info },
    edible: { emoji: '🍬', bg: colors.surface.warning },
    'pre-roll': { emoji: '🚬', bg: colors.surface.lightDarker },
    tincture: { emoji: '💊', bg: colors.surface.info },
    topical: { emoji: '🧴', bg: colors.surface.success },
    capsule: { emoji: '💊', bg: colors.surface.warning },
  }
  const icon = iconMap[category] || { emoji: '📦', bg: colors.surface.lightDarker }
  return (
    <div
      style={{
        width: '44px',
