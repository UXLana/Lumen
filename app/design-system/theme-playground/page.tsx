...
const STORAGE_KEY = 'lumen-custom-themes'
...
function generateTS(st: ThemeEditorState, name: string, base: number): string {
  ...
  return `/**
 * ${name} Product Theme
 * Generated by Lumen Theme Playground on ${new Date().toISOString().split('T')[0]}
...
export default function ThemePlaygroundPage() {
  ...
  return (
    <StyleguideLayout
      ...
      description="Visually design and export Lumen product themes with real-time preview."
      tagline="Your brand, your rules, your colors."
